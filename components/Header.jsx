...
function Header() {
  return (
    <header className="sticky top-0 left-0 bg-white z-50  h-20 border-b font-display flex items-center px-7 justify-between">
      ...
      <div className="bg-gray-50 w-3/4 rounded-3xl flex items-center border-[1px] px-2 md:w-1/4 sticky top-0 left-0 overflow-hidden">
        <Image
      ...
      <ul className="md:flex space-x-7 hidden  text-[#4629d3] text-base font-medium">
      ...
      <Link href="/">
        <a className="border hidden lg:inline-block border-[#4629d3] font-medium px-10 text-[#4629d3] py-2 rounded-full">Give $20 Get $10 </a>
      </Link>
